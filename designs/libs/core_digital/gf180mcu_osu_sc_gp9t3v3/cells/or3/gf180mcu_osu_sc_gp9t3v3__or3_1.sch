...
N 160 -270 160 -260 {lab=#net3}
N 160 -290 160 -270 {lab=#net3}
N 160 -290 330 -290 {lab=#net3}
N 330 -290 330 -260 {lab=#net3}
N 510 -290 510 -260 {lab=#net3}
N 330 -290 510 -290 {lab=#net3}
N 320 -380 320 -290 {lab=#net3}
...
N 680 -370 680 -260 {lab=Y}
N 680 -200 680 -180 {lab=VSS}
N 540 -180 680 -180 {lab=VSS}
N 680 -230 700 -230 {lab=VSS}
N 700 -230 700 -180 {lab=VSS}
N 680 -180 700 -180 {lab=VSS}
N 680 -400 700 -400 {lab=VDD}
N 700 -450 700 -400 {lab=VDD}
N 680 -450 700 -450 {lab=VDD}
N 680 -450 680 -430 {lab=VDD}
N 620 -400 640 -400 {lab=#net3}
N 620 -400 620 -230 {lab=#net3}
N 620 -230 640 -230 {lab=#net3}
N 510 -290 620 -290 {lab=#net3}
N 680 -290 750 -290 {lab=Y}
N 680 -650 680 -450 {lab=VDD}
N 340 -650 680 -650 {lab=VDD}
...
C {opin.sym} 750 -290 0 0 {name=p6 lab=Y}
...
C {title.sym} 30 -20 0 0 {name=l1 author="Aditya Mohapatra Chipathon'25 D14:SILICON_BBI1"}
C {symbols/nfet_03v3.sym} 660 -230 0 0 {name=M7
L=0.3u
W=0.85u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 660 -400 0 0 {name=M8
L=0.3u
W=1.7u
nf=1
m=1
