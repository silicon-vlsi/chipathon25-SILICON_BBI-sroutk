...
C {lab_wire.sym} 640 -180 2 0 {name=l14 sig_type=std_logic lab=VSS}
...
C {lab_wire.sym} 220 10 2 0 {name=l18 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 140 10 0 0 {name=l19 sig_type=std_logic lab=C}
C {iopin.sym} 130 -350 0 0 {name=p2 lab=VDD}
C {iopin.sym} 270 -350 0 0 {name=p6 lab=VDD}
C {iopin.sym} 430 -350 0 0 {name=p7 lab=VDD}
C {iopin.sym} 620 -350 0 0 {name=p8 lab=VDD}
C {iopin.sym} 620 -130 0 0 {name=p9 lab=VSS}
C {iopin.sym} 200 70 0 0 {name=p10 lab=VSS}
