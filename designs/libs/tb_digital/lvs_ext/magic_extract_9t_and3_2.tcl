...
load ../../core_digital/gf180mcu_osu_sc_gp9t3v3/cells/and3/gf180mcu_osu_sc_gp9t3v3__and3_2.mag
...
ext2spice cthresh 1            ;# Extract all capacitances

# Output the SPICE file, in ngspice format, with a chosen output filename
ext2spice -d -o gf180mcu_osu_sc_gp9t3v3__and3_2_ext.spice -f ngspice
